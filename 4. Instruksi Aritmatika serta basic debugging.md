...
### Multiplication
Pada multiplication atau perkalian dalam assembly, sumber akan dikalikan dengan nilai di AL, AX, EAX, atau RAX.

Tergantung ukuran register operan sumber.

Defaultnya adalah 32 bit yang dimana akan mengalikan dengan EAX

`imul` untuk perkalian unsigned.
