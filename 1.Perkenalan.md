...
![gambar](https://user-images.githubusercontent.com/86765295/170268634-de36b6a2-3ded-42ac-83e4-4320fe0fe9d5.png)
...
```c
syscall_nr(arg0, arg1, arg2, arg3, arg4, arg5)
rax(rdi, rsi, rdx, r10, r8, r9)
```

Kalian juga bisa baca-baca `man 2 syscall`.

Penjelasan lebih lanjut tentang calling-convention ini akan kita lanjut di bab register.

<br/>

> Fun fact: Calling convention di atas adalah System V ABI untuk arsitektur amd64
> 
...
mov edi, STDOUT_FILENO
```
Memasukkan nomor fd **stdout** ke dalam **edi**.
...
> Catatan : Seperti array dalam C/C++, **msg** tanpa `[]` adalah alamat.
...
syscall **\_exit** sudah selesai jadi kita memanggil kernel dengan instruksi `syscall` untuk melakukan **sys_exit**.
...
Nampak di atas kalau program yang tadi kita buat melakukan **sys_write** dan **sys_exit** .
